                      ...
                      <>
                        ...
                        {matchedSpecies ? (
                          <>
                            ...
                            <div>
                              ...
                              <ul className="space-y-2">
                                {matchedSpecies.healthChecklist.map((item, i) => (
                                  <li
                                    key={i}
                          ...
                          <div className="p-4 rounded-xl border border-dashed border-amber-300 bg-amber-50 text-amber-900">
                            <h4 className="font-bold mb-1">Needs human review</h4>
                            <p className="text-sm opacity-90">
                              We couldn&apos;t confidently map this AI result to a
                              local Shell &amp; Fin MY species profile yet, so
